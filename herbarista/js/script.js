      ...
      if (el.closest("summary") && el.closest("[data-spollers]")) {
        ...
        if (el.closest("[data-spollers]").classList.contains("_spoller-init")) {
          ...
          if (!spollersBlock.querySelectorAll("._slide").length) {
            ...
            spollersBlock.classList.toggle("_spoller-open");
          ...
          spollersClose.forEach((spollerClose) => {
            ...
            if (spollersBlock.classList.contains("_spoller-init")) {
              const spollerSpeed = spollersBlock.dataset.spollersSpeed
                ? parseInt(spollersBlock.dataset.spollersSpeed)
                : 500;
              spollersBlock.classList.remove("_spoller-open");
...
window.addEventListener("load", function () {
  ...
  const filtering = () => {
    const filteringNav = document.querySelector("[data-filtering-nav]");
    const filteringBtns = filteringNav.querySelectorAll("[data-filtering-btn]");

    filteringNav.addEventListener("click", (e) => {
      const targetElement = e.target;

      filteringBtns.forEach((filteringBtn) => {
        filteringBtn.classList.toggle("_is-active", filteringBtn == targetElement);
      });

      if (targetElement.closest("[data-filtering-btn]")) {
        const filteringTargetType = targetElement.getAttribute("data-filtering-btn");
        const filteringElements = document.querySelectorAll("[data-filtering-item]");

        filteringElements.forEach((filteringItem) => {
          const filteringItemType = filteringItem.getAttribute("data-filtering-item");

          filteringItem.hidden =
            filteringTargetType == "all"
              ? false
              : filteringTargetType == filteringItemType
              ? false
              : true;
        });
      }
  ...
  if (document.querySelector("[data-filtering-nav]")) {
    filtering();
  }
  ...
  if (document.querySelector(".welcome-slider")) {
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](".welcome-slider", {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.EffectFade],
      slidesPerView: 1,
      effect: "fade",
      fadeEffect: {
        crossFade: true,
  ...
  if (document.querySelector(".extra-slider")) {
    ...
    function responsiveSliders() {
      if (window.innerWidth < responsiveBreakpoint) {
        ...
        extraSlider = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](extraSliderBody, {
      ...
      if (window.innerWidth >= responsiveBreakpoint) {
        ...
        extraSlider = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](extraSliderBody, {
          modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.EffectFade],
          slidesPerView: 1,
          effect: "fade",
          fadeEffect: {
            crossFade: true,
  ...
  if (document.querySelector(".categories__slider")) {
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](".categories__slider", {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Pagination],
      slidesPerView: "auto",
      spaceBetween: 6,
  ...
  if (document.querySelector(".product__media")) {
    ...
    const previewSliderVideos = previewSliderBody.querySelectorAll("video");
    const previewSlides = previewSliderBody.querySelectorAll(".product-preview__item");
    const thumbsSliderBody = document.querySelector(".product-thumbs");
    const thumbsSliderVideos = thumbsSliderBody.querySelectorAll("video");
    const responsiveBreakpoint = 480;
    const matchMediaSlider = window.matchMedia(`(min-width: ${responsiveBreakpoint}px)`);
    let previewSlider;
    let thumbsSlider;

    if (previewSliderVideos.length) {
      previewSliderVideos.forEach((video) => {
    ...
    if (thumbsSliderVideos.length) {
      thumbsSliderVideos.forEach((video) => {
        video.autoplay = false;
        video.controls = false;
        video.loop = false;
    ...
    const playVideo = (swiper) => {
      ...
      const activeSlide = swiper.el.querySelectorAll(".product-preview__item")[activeIndex];
    ...
    function responsiveSliders() {
      if (window.innerWidth < responsiveBreakpoint) {
        ...
        if (previewSlides.length > 1) {
          ...
          previewSlider = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](previewSliderBody, {
            modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.EffectFade],
            slidesPerView: 1,
            effect: "fade",
            fadeEffect: {
              crossFade: true,
      ...
      if (window.innerWidth >= responsiveBreakpoint) {
        ...
        if (thumbsSliderBody) {
          ...
          thumbsSlider = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](thumbsSliderBody, {
            modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.FreeMode, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Mousewheel],
            slidesPerView: "auto",
            spaceBetween: 6,
          ...
          previewSliderBody.classList.add("_is-init");
          previewSlider = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](previewSliderBody, {
            modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__.EffectFade, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Thumbs],
            slidesPerView: 1,
            effect: "fade",
            fadeEffect: {
              crossFade: true,
          ...
          previewSlider = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](previewSliderBody, {
            modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__.EffectFade],
            slidesPerView: 1,
            effect: "fade",
            fadeEffect: {
              crossFade: true,
  ...
  if (document.querySelector(".default-slider")) {
    ...
    defaultSliders.forEach((el, i) => {
      ...
      let defaultSlider = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](el, {
        modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Pagination],
        slidesPerView: "auto",
        spaceBetween: 6,
  ...
  if (document.querySelector(".cabinet-extra")) {
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](extraSliderElement, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_5__.EffectFade],
      slidesPerView: 1,
      effect: "fade",
      fadeEffect: {
