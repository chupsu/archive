...
/* harmony export */ });
/* harmony import */ var _virtual_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
/* harmony import */ var _keyboard_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
/* harmony import */ var _mousewheel_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var _navigation_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(11);
/* harmony import */ var _pagination_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13);
/* harmony import */ var _scrollbar_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(15);
/* harmony import */ var _parallax_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16);
/* harmony import */ var _zoom_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
/* harmony import */ var _controller_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(18);
/* harmony import */ var _a11y_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(19);
/* harmony import */ var _history_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(20);
/* harmony import */ var _hash_navigation_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(21);
/* harmony import */ var _autoplay_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(22);
/* harmony import */ var _thumbs_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(23);
/* harmony import */ var _free_mode_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(24);
/* harmony import */ var _grid_mjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(25);
/* harmony import */ var _manipulation_mjs__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(26);
/* harmony import */ var _effect_fade_mjs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(27);
/* harmony import */ var _effect_cube_mjs__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(31);
/* harmony import */ var _effect_flip_mjs__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(32);
/* harmony import */ var _effect_coverflow_mjs__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(34);
/* harmony import */ var _effect_creative_mjs__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(35);
/* harmony import */ var _effect_cards_mjs__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(36);
...
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
...
window.addEventListener("load", function () {
  ...
  const shopsHide = (shopsCount) => {
    ...
    const shopsShowBtn = shopsBody.querySelector(".shops__item_more .shops__more");

    if (shops.length > shopsCount) {
      shopsBody.classList.add("_is-init");
      shopsBody.classList.remove("_is-lock");

      shopsShowBtn.onclick = (e) => {
        e.preventDefault();

        shopsBody.classList.toggle("_is-init");
      };
    } else {
      shopsBody.classList.remove("_is-init");
      shopsBody.classList.add("_is-lock");
    }
  };
  ...
  if (document.querySelector(".substance-slider")) {
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".substance-slider", {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination],
      slidesPerView: "auto",
      spaceBetween: 12,
      wrapperClass: "substance-slider__items",
      slideClass: "substance-slider__item",
      slideActiveClass: "substance-slider__item_active",
      slidePrevClass: "substance-slider__item_prev",
      slideNextClass: "substance-slider__item_next",
      pagination: {
        bulletElement: "span",
        el: ".substance-slider__pagination",
        lockClass: "_is-lock",
        bulletClass: "substance-slider__bullet",
  ...
  if (document.querySelector(".effect-slider")) {
    document.querySelector(".effect-slider").classList.add("_is-init");

    new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".effect-slider", {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation],
      slidesPerView: "auto",
      spaceBetween: 12,
      wrapperClass: "effect-slider__items",
      slideClass: "effect-slider__item",
      slideActiveClass: "effect-slider__item_active",
      slidePrevClass: "effect-slider__item_prev",
      slideNextClass: "effect-slider__item_next",
      navigation: {
        prevEl: ".effect-slider__btn_prev",
        nextEl: ".effect-slider__btn_next",
        disabledClass: "effect-slider__btn_disabled",
        lockClass: "_is-lock",
      },
      pagination: {
        bulletElement: "span",
        el: ".effect-slider__pagination",
        lockClass: "_is-lock",
        bulletClass: "effect-slider__bullet",
        bulletActiveClass: "_is-active",
      },
      breakpoints: {
        1024: { spaceBetween: 18 },
  ...
  if (document.querySelector(".tools-slider")) {
    document.querySelector(".tools-slider").classList.add("_is-init");

    new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".tools-slider", {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination],
      slidesPerView: "auto",
      spaceBetween: 12,
      wrapperClass: "tools-slider__items",
      slideClass: "tools-slider__item",
      slideActiveClass: "tools-slider__item_active",
      slidePrevClass: "tools-slider__item_prev",
      slideNextClass: "tools-slider__item_next",
      pagination: {
        bulletElement: "span",
        el: ".tools-slider__pagination",
        lockClass: "_is-lock",
        bulletClass: "tools-slider__bullet",
        bulletActiveClass: "_is-active",
      },
      breakpoints: {
        1024: { spaceBetween: 18 },
