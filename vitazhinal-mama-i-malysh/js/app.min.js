(() => {
    ...
    let e = !0, t = (t = 500) => {
        ...
        if (e) {
            ...
            setTimeout((() => {
                ...
                s.style.paddingRight = "0px", document.documentElement.classList.remove("_lock")
            }), t), e = !1, setTimeout((function () {
                e = !0
            }), t)
        }
    }, s = (t = 500) => {
        ...
        if (e) {
            ...
            s.style.paddingRight = window.innerWidth - document.querySelector(".wrapper").offsetWidth + "px", document.documentElement.classList.add("_lock"), e = !1, setTimeout((function () {
                e = !0
            }), t)
        }
    };
    ...
    function i() {
        const e = document.querySelectorAll("[data-menu-open]"), s = document.querySelector("[data-menu]");
        e.length && s && (t(), e.forEach((e => {
            e.classList.remove("_menu-active")
        })), s.classList.remove("_menu-active"))
    }

    const n = document.querySelectorAll("[data-menu-close]");
    n.length && (n.forEach((e => {
        e.addEventListener("click", (e => {
            e.preventDefault(), i()
        }))
    })), document.addEventListener("click", (e => {
        e.target.closest("[data-menu-main]") || e.target.closest("[data-menu-open]") || i()
    })));
    const r = document.querySelectorAll(".table-intro__row"), a = document.querySelectorAll(".table-intro__name"),
        o = document.querySelector(".intro__arrow_left"), l = document.querySelector(".intro__arrow_right");
    if (r.length && o && l && a.length) {
        let e = 0;
        l.addEventListener("click", (t => {
            t.preventDefault(), e < a.length - 1 && (e++, e == a.length - 1 && l.classList.add("_disabled"), r.forEach((t => {
                const s = t.querySelectorAll(".table-intro__item");
                s.length && (s.forEach((e => {
                    e.classList.remove("_active")
                })), s[e].classList.add("_active")), a.forEach((e => {
                    e.classList.remove("_active")
                })), a[e].classList.add("_active"), o.classList.remove("_disabled")
            })))
        })), o.addEventListener("click", (t => {
            t.preventDefault(), e > 0 && (e--, 0 == e && o.classList.add("_disabled"), r.forEach((t => {
                const s = t.querySelectorAll(".table-intro__item");
                s.length && (s.forEach((e => {
                    e.classList.remove("_active")
                })), s[e].classList.add("_active")), a.forEach((e => {
                    e.classList.remove("_active")
                })), a[e].classList.add("_active"), l.classList.remove("_disabled")
            })))
        }))
    }
    ...
    function S(e) {
        return function (...t) {
            if (void 0 === t[0]) {
                for (let t = 0; t < this.length; t += 1) b.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : w(this[t]).trigger(e));
                return this
            }
            return this.on(e, ...t)
        }
    ...
    const T = {
        addClass: function (...e) {
            ...
            function r(e) {
                ...
                if (n.indexOf(e) < 0 && n.unshift(e), w(t).is(s)) i.apply(t, n); else {
                    const e = w(t).parents();
                    for (let t = 0; t < e.length; t += 1) w(e[t]).is(s) && i.apply(e[t], n)
                }
            }
            ...
            for (let e = 0; e < r.length; e += 1) {
                ...
                for (let e = 0; e < this.length; e += 1) {
                    const r = this[e];
                    let a;
                    if (!s && r.dom7Listeners ? a = r.dom7Listeners[t] : s && r.dom7LiveListeners && (a = r.dom7LiveListeners[t]), a && a.length) for (let e = a.length - 1; e >= 0; e -= 1) {
                        const s = a[e];
            ...
            if (this.length > 0) {
                const e = f(), t = u(), s = this[0], i = s.getBoundingClientRect(), n = t.body,
                    r = s.clientTop || n.clientTop || 0, a = s.clientLeft || n.clientLeft || 0,
                    o = s === e ? e.scrollY : s.scrollTop, l = s === e ? e.scrollX : s.scrollLeft;
            ...
            for (let i = 0; i < e.length; i += 1) {
                ...
                } else if (t instanceof m) for (let s = 0; s < t.length; s += 1) this[e].appendChild(t[s]); else this[e].appendChild(t)
            }
            return this
        }, prepend: function (e) {
            const t = u();
            ...
            } else if (e instanceof m) for (i = 0; i < e.length; i += 1) this[s].insertBefore(e[i], this[s].childNodes[0]); else this[s].insertBefore(e, this[s].childNodes[0]);
            return this
        }, next: function (e) {
    ...
    Object.keys(T).forEach((e => {
        Object.defineProperty(w.fn, e, {value: T[e], writable: !0})
    }));
    const E = w;
        ...
        for (let n = 1; n < e.length; n += 1) {
            ...
            if (null != r && (i = r, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                ...
                for (let s = 0, i = e.length; s < i; s += 1) {
                    const i = e[s], n = Object.getOwnPropertyDescriptor(r, i);
                    void 0 !== n && n.enumerable && (L(t[i]) && L(r[i]) ? r[i].__swiper__ ? t[i] = r[i] : k(t[i], r[i]) : !L(t[i]) && L(r[i]) ? (t[i] = {}, r[i].__swiper__ ? t[i] = r[i] : k(t[i], r[i])) : t[i] = r[i])
                }
            }
        }
        var i;
    ...
    function P({swiper: e, targetPosition: t, side: s}) {
        const i = f(), n = -e.translate;
        let r, a = null;
        const o = e.params.speed;
        e.wrapperEl.style.scrollSnapType = "none", i.cancelAnimationFrame(e.cssModeFrameID);
        const l = t > n ? "next" : "prev", d = (e, t) => "next" === l && e >= t || "prev" === l && e <= t, c = () => {
            r = (new Date).getTime(), null === a && (a = r);
            const l = Math.max(Math.min((r - a) / o, 1), 0), p = .5 - Math.cos(l * Math.PI) / 2;
            let u = n + p * (t - n);
            if (d(u, t) && (u = t), e.wrapperEl.scrollTo({[s]: u}), d(u, t)) return e.wrapperEl.style.overflow = "hidden", e.wrapperEl.style.scrollSnapType = "", setTimeout((() => {
    ...
    function I(e = {}) {
        return O || (O = function ({userAgent: e} = {}) {
            const t = _(), s = f(), i = s.navigator.platform, n = e || s.navigator.userAgent,
                r = {ios: !1, android: !1}, a = s.screen.width, o = s.screen.height,
                l = n.match(/(Android);?[\s\/]+([\d.]+)?/);
            let d = n.match(/(iPad).*OS\s([\d_]+)/);
            const c = n.match(/(iPod)(.*OS\s([\d_]+))?/), p = !d && n.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
                u = "Win32" === i;
            let h = "MacIntel" === i;
            return !d && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${a}x${o}`) >= 0 && (d = n.match(/(Version)\/([\d.]+)/), d || (d = [0, 1, "13_0_0"]), h = !1), l && !u && (r.os = "android", r.android = !0), (d || p || c) && (r.os = "ios", r.ios = !0), r
        }(e)), O
    }
    ...
    const G = {
        updateSize: function () {
            ...
            const i = e.params, {$wrapperEl: n, size: r, rtlTranslate: a, wrongRTL: o} = e,
                l = e.virtual && i.virtual.enabled, d = l ? e.virtual.slides.length : e.slides.length,
                c = n.children(`.${e.params.slideClass}`), p = l ? e.virtual.slides.length : c.length;
            let u = [];
            const h = [], f = [];
            ...
            let b = i.spaceBetween, S = -m, T = 0, E = 0;
            if (void 0 === r) return;
            ...
            for (let n = 0; n < p; n += 1) {
                ...
                if (y && e.grid.updateSlide(n, a, p, t), "none" !== a.css("display")) {
                    if ("auto" === i.slidesPerView) {
                        ...
                        if (o && (a[0].style.transform = "none"), l && (a[0].style.webkitTransform = "none"), i.roundLengths) C = e.isHorizontal() ? a.outerWidth(!0) : a.outerHeight(!0); else {
                            const e = s(r, "width"), t = s(r, "padding-left"), i = s(r, "padding-right"),
                                n = s(r, "margin-left"), o = s(r, "margin-right"), l = r.getPropertyValue("box-sizing");
                            if (l && "border-box" === l) C = e + n + o; else {
                                const {clientWidth: s, offsetWidth: r} = a[0];
                                C = e + t + i + n + o + (r - s)
                            }
                        }
                        o && (a[0].style.transform = o), l && (a[0].style.webkitTransform = l), i.roundLengths && (C = Math.floor(C))
                    } else C = (r - (i.slidesPerView - 1) * b) / i.slidesPerView, i.roundLengths && (C = Math.floor(C)), c[n] && (c[n].style[t("width")] = `${C}px`);
                    c[n] && (c[n].swiperSlideSize = C), f.push(C), i.centeredSlides ? (S = S + C / 2 + T / 2 + b, 0 === T && 0 !== n && (S = S - r / 2 - b), 0 === n && (S = S - r / 2 - b), Math.abs(S) < .001 && (S = 0), i.roundLengths && (S = Math.floor(S)), E % i.slidesPerGroup == 0 && u.push(S), h.push(S)) : (i.roundLengths && (S = Math.floor(S)), (E - Math.min(e.params.slidesPerGroupSkip, E)) % e.params.slidesPerGroup == 0 && u.push(S), h.push(S), S = S + C + b), e.virtualSize += C + b, T = C, E += 1
                }
            }
            if (e.virtualSize = Math.max(e.virtualSize, r) + g, a && o && ("slide" === i.effect || "coverflow" === i.effect) && n.css({width: `${e.virtualSize + i.spaceBetween}px`}), i.setWrapperSize && n.css({[t("width")]: `${e.virtualSize + i.spaceBetween}px`}), y && e.grid.updateWrapperSize(C, u, t), !i.centeredSlides) {
                const t = [];
            ...
            if ("auto" !== t.params.slidesPerView && t.params.slidesPerView > 1) if (t.params.centeredSlides) (t.visibleSlides || E([])).each((e => {
                s.push(e)
            ...
            const e = this, {slides: t, params: s, $wrapperEl: i, activeIndex: n, realIndex: r} = e,
            ...
            const t = this, s = t.params, i = E(e).closest(`.${s.slideClass}`)[0];
            let n, r = !1;
            ...
            t.clickedSlide = i, t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(E(i).attr("data-swiper-slide-index"), 10) : t.clickedIndex = n, s.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex && t.slideToClickedSlide()
        }
    };
    const N = {
        getTranslate: function (e = (this.isHorizontal() ? "x" : "y")) {
            ...
            const s = this, {rtlTranslate: i, params: n, $wrapperEl: r, wrapperEl: a, progress: o} = s;
            let l, d = 0, c = 0;
    ...
    function B({swiper: e, runCallbacks: t, direction: s, step: i}) {
    ...
    const V = {
        slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
            ...
            let w;
            if (a !== (c || 0) && s && r.emit("beforeSlideChangeStart"), r.updateProgress(v), w = a > p ? "next" : a < p ? "prev" : "reset", u && -v === r.translate || !u && v === r.translate) return r.updateActiveIndex(a), o.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== o.effect && r.setTranslate(v), "reset" !== w && (r.transitionStart(s, w), r.transitionEnd(s, w)), !1;
            if (o.cssMode) {
                ...
                if (0 === t) {
                    ...
                    if (!r.support.smoothScroll) return P({swiper: r, targetPosition: s, side: e ? "left" : "top"}), !0;
            ...
            const i = this, {params: n, animating: r, snapGrid: a, slidesGrid: o, rtlTranslate: l, enabled: d} = i;
            if (!d) return i;
            if (n.loop) {
            ...
            const p = c(l ? i.translate : -i.translate), u = a.map((e => c(e)));
            ...
            const n = this;
            let r = n.activeIndex;
            const a = Math.min(n.params.slidesPerGroupSkip, r), o = a + Math.floor((r - a) / n.params.slidesPerGroup),
            ...
            if (t.loop) {
                ...
                n = parseInt(E(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - i / 2 || r > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), r = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), y((() => {
                    e.slideTo(r)
                }))) : e.slideTo(r) : r > e.slides.length - i ? (e.loopFix(), r = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), y((() => {
                    e.slideTo(r)
                }))) : e.slideTo(r)
            } else e.slideTo(r)
        }
    ...
    const q = {
        loopCreate: function () {
            const e = this, t = u(), {params: s, $wrapperEl: i} = e,
            ...
            if (s.loopFillGroupWithBlank) {
                ...
                if (e !== s.slidesPerGroup) {
                    for (let i = 0; i < e; i += 1) {
                        const e = E(t.createElement("div")).addClass(`${s.slideClass} ${s.slideBlankClass}`);
                        n.append(e)
                    }
            ...
            for (let e = 0; e < o.length; e += 1) n.append(E(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    ...
    function H(e) {
        const t = this, s = u(), i = f(), n = t.touchEventsData, {params: r, touches: a, enabled: o} = t;
        if (!o) return;
        ...
        c && l.target && l.target.shadowRoot && p && (d = E(p[0]));
        ...
        const g = a.currentX, v = a.currentY, w = r.edgeSwipeDetection || r.iOSEdgeSwipeDetection,
        ...
        if (Object.assign(n, {
            ...
            isScrolling: void 0,
            startMoving: void 0
        }), a.startX = g, a.startY = v, n.touchStartTime = C(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, r.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== l.type) {
            let e = !0;
            d.is(n.focusableElements) && (e = !1, "SELECT" === d[0].nodeName && (n.isTouched = !1)), s.activeElement && E(s.activeElement).is(n.focusableElements) && s.activeElement !== d[0] && s.activeElement.blur();
    ...
    function j(e) {
        const t = u(), s = this, i = s.touchEventsData, {params: n, touches: r, rtlTranslate: a, enabled: o} = s;
        if (!o) return;
        let l = e;
        ...
        const d = "touchmove" === l.type && l.targetTouches && (l.targetTouches[0] || l.changedTouches[0]),
            c = "touchmove" === l.type ? d.pageX : l.pageX, p = "touchmove" === l.type ? d.pageY : l.pageY;
        if (l.preventedByNestedSwiper) return r.startX = c, void (r.startY = p);
        if (!s.allowTouchMove) return E(l.target).is(i.focusableElements) || (s.allowClick = !1), void (i.isTouched && (Object.assign(r, {
            startX: c,
            startY: p,
            currentX: c,
            currentY: p
        ...
        if (i.isTouchEvent && t.activeElement && l.target === t.activeElement && E(l.target).is(i.focusableElements)) return i.isMoved = !0, void (s.allowClick = !1);
    ...
    function W(e) {
        const t = this, s = t.touchEventsData, {params: i, touches: n, rtlTranslate: r, slidesGrid: a, enabled: o} = t;
        if (!o) return;
        let l = e;
        ...
        const d = C(), c = d - s.touchStartTime;
        if (t.allowClick) {
    ...
    const K = (e, t) => {
        const s = u(), {params: i, touchEvents: n, el: r, wrapperEl: a, device: o, support: l} = e, d = !!i.nested,
        ...
        } else r[c](n.start, e.onTouchStart, !1), s[c](n.move, e.onTouchMove, d), s[c](n.end, e.onTouchEnd, !1);
        (i.preventClicks || i.preventClicksPropagation) && r[c]("click", e.onClick, !0), i.cssMode && a[c]("scroll", e.onScroll), i.updateOnWindowResize ? e[p](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", F, !0) : e[p]("observerUpdate", F, !0)
    };
    const J = {
        attachEvents: function () {
            const e = this, t = u(), {params: s, support: i} = e;
            e.onTouchStart = H.bind(e), e.onTouchMove = j.bind(e), e.onTouchEnd = W.bind(e), s.cssMode && (e.onScroll = X.bind(e)), e.onClick = R.bind(e), i.touch && !Y && (t.addEventListener("touchstart", U), Y = !0), K(e, "on")
    ...
    const Z = {
        setBreakpoint: function () {
            const e = this, {activeIndex: t, initialized: s, loopedSlides: i = 0, params: n, $el: r} = e,
                a = n.breakpoints;
            if (!a || a && 0 === Object.keys(a).length) return;
            const o = e.getBreakpoint(a, e.params.breakpointsBase, e.el);
            if (!o || e.currentBreakpoint === o) return;
            const l = (o in a ? a[o] : void 0) || e.originalParams, d = Q(e, n), c = Q(e, l), p = n.enabled;
            d && !c ? (r.removeClass(`${n.containerModifierClass}grid ${n.containerModifierClass}grid-column`), e.emitContainerClasses()) : !d && c && (r.addClass(`${n.containerModifierClass}grid`), (l.grid.fill && "column" === l.grid.fill || !l.grid.fill && "column" === n.grid.fill) && r.addClass(`${n.containerModifierClass}grid-column`), e.emitContainerClasses()), ["navigation", "pagination", "scrollbar"].forEach((t => {
                const s = n[t] && n[t].enabled, i = l[t] && l[t].enabled;
            ...
            let i = !1;
            const n = f(), r = "window" === t ? n.innerHeight : s.clientHeight, a = Object.keys(e).map((e => {
    ...
    const ee = {
        addClasses: function () {
            const e = this, {classNames: t, params: s, rtl: i, $el: n, device: r, support: a} = e, o = function (e, t) {
                const s = [];
                return e.forEach((e => {
    ...
    const ie = {
        eventsEmitter: z, update: G, translate: N, transition: {
        ...
        }, events: J, breakpoints: Z, checkOverflow: {
            ...
            loadImage: function (e, t, s, i, n, r) {
                ...
                E(e).parent("picture")[0] || e.complete && n ? l() : t ? (o = new a.Image, o.onload = l, o.onerror = l, i && (o.sizes = i), s && (o.srcset = s), t && (o.src = t)) : l()
    ...
    class re {
        constructor(...e) {
            let t, s;
            if (1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? s = e[0] : [t, s] = e, s || (s = {}), s = k({}, s), t && !s.el && (s.el = t), s.el && E(s.el).length > 1) {
                const e = [];
                return E(s.el).each((t => {
                    const i = k({}, s, {el: t});
                    e.push(new re(i))
                })), e
            }
            const i = this;
            i.__swiper__ = !0, i.support = _(), i.device = I({userAgent: s.userAgent}), i.browser = D(), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [...i.__modules__], s.modules && Array.isArray(s.modules) && i.modules.push(...s.modules);
            const n = {};
            i.modules.forEach((e => {
                e({
                    swiper: i,
            ...
            const r = k({}, te, n);
            return i.params = k({}, r, ne, s), i.originalParams = k({}, i.params), i.passedParams = k({}, s), i.params && i.params.on && Object.keys(i.params.on).forEach((e => {
                i.on(e, i.params.on[e])
            })), i.params && i.params.onAny && i.onAny(i.params.onAny), i.$ = E, Object.assign(i, {
        ...
        mount(e) {
            ...
            if (0 === n.length && t.params.createElements) {
                ...
                n = E(e), e.className = t.params.wrapperClass, s.append(e), s.children(`.${t.params.slideClass}`).each((e => {
                    n.append(e)
                }))
            }
    ...
    })), re.use([function ({swiper: e, on: t, emit: s}) {
        const i = f();
        let n = null, r = null;
        const a = () => {
    ...
    function oe({swiper: e, extendParams: t, on: s, emit: i}) {
        ...
        function a(t) {
            ...
            const o = a.keyCode || a.charCode, l = e.params.keyboard.pageUpDown, d = l && 33 === o, c = l && 34 === o,
                p = 37 === o, u = 39 === o, h = 38 === o, f = 40 === o;
            ...
            if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || n.activeElement && n.activeElement.nodeName && ("input" === n.activeElement.nodeName.toLowerCase() || "textarea" === n.activeElement.nodeName.toLowerCase()))) {
                if (e.params.keyboard.onlyInViewport && (d || c || p || u || h || f)) {
                    ...
                    const i = e.$el, n = i[0].clientWidth, a = i[0].clientHeight, o = r.innerWidth, l = r.innerHeight,
                        d = e.$el.offset();
                    s && (d.left -= e.$el[0].scrollLeft);
                    const c = [[d.left, d.top], [d.left + n, d.top], [d.left, d.top + a], [d.left + n, d.top + a]];
                ...
                e.isHorizontal() ? ((d || c || p || u) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), ((c || u) && !s || (d || p) && s) && e.slideNext(), ((d || p) && !s || (c || u) && s) && e.slidePrev()) : ((d || c || h || f) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), (c || f) && e.slideNext(), (d || h) && e.slidePrev()), i("keyPress", o)
            }
        }

        function o() {
            e.keyboard.enabled || (E(n).on("keydown", a), e.keyboard.enabled = !0)
        }

        function l() {
            e.keyboard.enabled && (E(n).off("keydown", a), e.keyboard.enabled = !1)
        }
    ...
    function le({swiper: e, extendParams: t, on: s, emit: i}) {
        function n(t) {
            let s;
            return t && (s = E(t), e.params.uniqueNavElements && "string" == typeof t && s.length > 1 && 1 === e.$el.find(t).length && (s = e.$el.find(t))), s
        }
        ...
        function d() {
            ...
            const s = n(t.nextEl), i = n(t.prevEl);
        ...
        t({
            ...
            const {$nextEl: n, $prevEl: r} = e.navigation, a = s.target;
        ...
        Object.assign(e.navigation, {
            ...
            }, disable: p, update: a, init: d, destroy: c
        })
    }

    window.addEventListener("load", (function () {
        document.querySelector(".intro__slider") && new ae(".intro__slider", {
            modules: [le, oe],
            slidesPerView: 1,
            spaceBetween: 0,
            speed: 500,
            ...
            observer: !0,
            observeParents: !0,
            keyboard: {enabled: !0, onlyInViewport: !0, pageUpDown: !1}
        }), document.querySelector(".intro__slider-2") && new ae(".intro__slider-2", {
            modules: [le, oe],
            slidesPerView: 1,
            spaceBetween: 0,
            initialSlide: 1,
        ...
        const i = document.querySelectorAll("[data-menu-open]"), n = document.querySelector("[data-menu]");
        i.length && n && i.forEach((i => {
            i.addEventListener("click", (r => {
                r.preventDefault(), e && (((e = 500) => {
                    document.documentElement.classList.contains("_lock") ? t(e) : s(e)
                })(), i.classList.toggle("_menu-active"), n.classList.toggle("_menu-active"))
            }))
        }))
    }(), function () {
        const e = document.querySelectorAll("[data-open]");
        e.length && e.forEach((e => {
            const t = e.querySelector("[data-open-btn]"), s = e.querySelector("[data-open-body]"),
                n = e.querySelector("[data-open-fill]"), r = e.querySelector("[data-open-close]");
            t && s && n && (t.addEventListener("click", (function (e) {
                n.classList.toggle("_active"), s.classList.toggle("_active"), t.classList.toggle("_active"), document.querySelector("._menu-active") && i(), e.preventDefault()
            })), document.addEventListener("click", (function (e) {
                e.target.closest("[data-open-body]") || e.target.closest("[data-open-btn]") || (t.classList.remove("_active"), s.classList.remove("_active"), n.classList.remove("_active"))
            }))), r && t && s && n && r.addEventListener("click", (() => {
                t.classList.remove("_active"), s.classList.remove("_active"), n.classList.remove("_active")
            }))
        }))
    }()
})();