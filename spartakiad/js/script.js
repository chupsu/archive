...
class SelectConstructor {
  constructor(props, data = null) {
    ...
    this.selectClasses = {
      ...
      classSelectSearch: "_search", // Класс тега
  ...
  selectBuild(originalSelect) {
    ...
    originalSelect.hasAttribute("data-search")
      ? selectItem.classList.add(`select${this.selectClasses.classSelectSearch}`)
      : null;
  ...
  getSelectTitleValue(selectItem, originalSelect) {
    ...
    selectTitleValue = selectTitleValue.length
      ...
      ? originalSelect.dataset.placeholder
      : "";
    selectTitleValue = String(selectTitleValue).trim().replace(/\s+/g, " ");
    ...
    if (originalSelect.hasAttribute("data-search")) {
      ...
      return `<div class="${this.selectClasses.classSelectTitle}">
                <span class="${this.selectClasses.classSelectValue}" ${pseudoAttribute}>
                  <input class="${this.selectClasses.classSelectInput}" autocomplete="off" type="text" placeholder="${selectTitleValue}" data-placeholder="${selectTitleValue}">
                </span>
              </div>
            `;
    } else {
  ...
  selectCallback(selectItem, originalSelect) {
    ...
    // originalSelect.dispatchEvent(new CustomEvent("select:change", { detail: { value } }));
  }
}
...
/* harmony import */ var _modules_virtual_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/* harmony import */ var _modules_keyboard_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _modules_mousewheel_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
/* harmony import */ var _modules_navigation_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13);
/* harmony import */ var _modules_pagination_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(15);
/* harmony import */ var _modules_scrollbar_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(17);
/* harmony import */ var _modules_parallax_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(18);
/* harmony import */ var _modules_zoom_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(19);
/* harmony import */ var _modules_controller_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(20);
/* harmony import */ var _modules_a11y_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(21);
/* harmony import */ var _modules_history_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(22);
/* harmony import */ var _modules_hash_navigation_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(23);
/* harmony import */ var _modules_autoplay_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(24);
/* harmony import */ var _modules_thumbs_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(25);
/* harmony import */ var _modules_free_mode_mjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(26);
/* harmony import */ var _modules_grid_mjs__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(27);
/* harmony import */ var _modules_manipulation_mjs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(28);
/* harmony import */ var _modules_effect_fade_mjs__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(29);
/* harmony import */ var _modules_effect_cube_mjs__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(33);
/* harmony import */ var _modules_effect_flip_mjs__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(34);
/* harmony import */ var _modules_effect_coverflow_mjs__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(36);
/* harmony import */ var _modules_effect_creative_mjs__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(37);
/* harmony import */ var _modules_effect_cards_mjs__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(38);
/**
 * Swiper 11.2.10
...
/* harmony export */ });
/* harmony import */ var _air_datepicker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40);
...
/* harmony import */ var air_datepicker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(39);
...
window.AirDatepicker = air_datepicker__WEBPACK_IMPORTED_MODULE_6__["default"];
...
window.addEventListener("load", function () {
  ...
  if (document.querySelector(".promo-slider")) {
    ...
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_5__["default"](promoSliderBody, {
      slidesPerView: "auto",
      spaceBetween:
        gapNormalMin +
  ...
  if (document.querySelector(".category-slider")) {
    ...
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_5__["default"](".category-slider", {
      slidesPerView: "auto",
      freeMode: true,
      resistanceRatio: 0,
  ...
  if (document.querySelector(".h-blog-slider")) {
    ...
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_5__["default"](".h-blog-slider", {
      slidesPerView: "auto",
      spaceBetween:
        gapMediumMin +
  ...
  if (galleryPopupSliderBody) {
    ...
    galleryPopupSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_5__["default"](galleryPopupSliderBody, {
      slidesPerView: 1,
      speed: 0,
      effect: "fade",
      fadeEffect: {
  ...
  const dropdownPosition = (targetElement) => {
    const dropdownElement = targetElement.closest(".select__title").nextElementSibling;
  ...
  // const upload = () => {
  //   const uploadContainer = document.querySelector("[data-uploads]");
  //   const uploadInputs = uploadContainer.querySelectorAll('input[type="file"');
  //   const uploadPreviews = uploadContainer.querySelector("[data-uploads-previews]");
  ...
  if (document.querySelector("#datepicker")) {
    ...
    let schedule = new air_datepicker__WEBPACK_IMPORTED_MODULE_6__["default"](calendar, {
      minDate: Date.now() - 100 * 12 * 30.44 * 24 * 60 * 60 * 1000,
      maxDate: Date.now() - 16 * 12 * 30.44 * 24 * 60 * 60 * 1000,
      ...
      prevHtml: '<span class="icon-arr-left"></span>',
      nextHtml: '<span class="icon-arr-right"></span>',
    });
  }
  ...
  function documentActions(e) {
    ...
    if (
      targetElement.closest(".select__option") &&
      targetElement.parentElement.closest(".select_search")
    ) {
