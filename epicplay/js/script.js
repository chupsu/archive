...
window.addEventListener("load", function () {
  ...
  if (document.querySelector(".hero-slider")) {
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](".hero-slider", {
      ...
      slideClass: "hero-slider__item",
      slideActiveClass: "hero-slider__item_active",
      slidePrevClass: "hero-slider__item_prev",
      slideNextClass: "hero-slider__item_next",
      pagination: {
        clickable: false,
        bulletElement: "span",
        dynamicBullets: true,
      ...
      navigation: {
        ...
        disabledClass: "hero-slider__button_disabled",
        lockClass: "hero-slider__button_lock",
      },
      on: {
        resize: (swiper) => {
  ...
  if (document.querySelector(".related-slider")) {
    const relatedSliders = document.querySelectorAll(".related-slider");
    relatedSliders.forEach((el, i) => {
      ...
      let relatedSlider = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](el, {
        ...
        slideActiveClass: "related-slider__item_active",
        slidePrevClass: "related-slider__item_prev",
        slideNextClass: "related-slider__item_next",
        pagination: {
          clickable: false,
          bulletElement: "span",
          dynamicBullets: true,
          dynamicMainBullets: 1,
          el: el.querySelector(".related-slider__pagination"),
          lockClass: "_is-lock",
          bulletClass: "related-slider__bullet",
          bulletActiveClass: "_is-active",
        },
        navigation: {
          prevEl: el.querySelector(".related-slider__button_prev"),
          nextEl: el.querySelector(".related-slider__button_next"),
          disabledClass: "related-slider__button_disabled",
          lockClass: "related-slider__button_lock",
        },
        on: {
          resize: (swiper) => {
            swiper.params.spaceBetween =
  ...
  if (document.querySelector(".preview-slider")) {
    new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](".preview-slider", {
      ...
      pagination: {
        ...
        lockClass: "_is-lock",
        bulletClass: "preview-slider__bullet",
        bulletActiveClass: "_is-active",
      },
      navigation: {
        ...
        lockClass: "preview-slider__button_lock",
      },
    });
  }
  ...
  const variantsHide = () => {
    ...
    variantsBodies.forEach((variantsBody) => {
      ...
      if (variantsShowBtn && variants.length > 9) {
        ...
        variantsShowBtn.parentElement.style.display = "block";
