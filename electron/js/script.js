...
window.addEventListener("load", function () {
  ...
  if (document.querySelector(".h-categories-slider")) {
    ...
    categoriesSliders.forEach((el, i) => {
      ...
      new swiper_bundle__WEBPACK_IMPORTED_MODULE_5__["default"](el, {
        slidesPerView: "auto",
        spaceBetween: 6,
        resistanceRatio: 0,
    ...
    relationSliders.forEach((relationSliderBody, i) => {
      ...
      function responsiveInit() {
        ...
        if (window.innerWidth >= $md3) {
          ...
          relationSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_5__["default"](relationSliderWrapper, {
            slidesPerView: "auto",
            spaceBetween: 6,
            resistanceRatio: 0,
  ...
  if (document.querySelector(".news-slider")) {
    ...
    function responsiveInit() {
      if (window.innerWidth < $md2 && newsSliderBody.dataset.slider == "false") {
        ...
        newsSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_5__["default"](newsSliderBody, {
          slidesPerView: "auto",
          spaceBetween: 6,
          resistanceRatio: 0,
